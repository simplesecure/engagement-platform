...
export default class Segments extends React.Component {
  ...
  importUsers = async () => {
    ...
    await getCloudServices().getTokenTop50Wallets(sessionData.id, importAddress, false)
    await getCloudServices().getCustomChartData(sessionData.id, importAddress, false)
